...
// create header
  const header = document.createElement('header')
    header.className = 'header page-item';
...
// create elements for filters
  const filters = document.createElement('aside');
    filters.className = 'filters page-item'
  ...
  const filterCount = document.createElement('div');
    ...
    filterCount.className = 'options-counter'
...
const spinnerEl = document.createElement('section')
  spinnerEl.className = 'spinner page-item';
// render results
...
StuffPicker.prototype.renderFilters = function () {
  const columnWrapper = document.getElementsByClassName('column-wrapper')[0]
  const filters = document.createElement('aside');
  filters.className = 'filters page-item'
  ...
  columnWrapper.replaceChild(filters, document.getElementsByClassName('filters')[0]);
};
...
// render results
  ...
  spinnerEl.replaceChild(resultsEl, document.getElementsByClassName('results')[0]);
};
